<?php
	Class Mob52 extends Mob{
		//AVIDO CERCATORE D`ORO
		...
		public function buildTarget(&$tar){
			...
			if($res->num_rows == 0){
				$sql = "SELECT MOB_ID FROM BOT_RPG_MOB WHERE MOB_TIPO_MOB_ID = 53 AND MOB_SOTTOLUOGO_ID = ".$this->getMobSottoluogoId()." AND MOB_UTENTE_ID = ".$this->getMobUtenteId()." AND MOB_HP > 0 LIMIT 1";
